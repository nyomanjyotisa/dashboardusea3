...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('dashboard.lokasi.update', $lokasi->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    <div class="mb-4">
                        <label class="form-label" for="lokasi">Lokasi</label>
                        <input class="form-control" value="<?php echo e($lokasi->nama_lokasi); ?>" type="text" id="lokasi" name="nama_lokasi" placeholder="Lokasi">
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\job\dashboardusea3\resources\views/lokasi/edit.blade.php ENDPATH**/ ?>