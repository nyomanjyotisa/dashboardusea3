            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-2 text-right">
                        <a class="btn btn-primary" href="<?php echo e(route('users.create')); ?>">Tambah</a>
                    </div>
                </div>
                </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\job\dashboardusea3\resources\views/users/index.blade.php ENDPATH**/ ?>