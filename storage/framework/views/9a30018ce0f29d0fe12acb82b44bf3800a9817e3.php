...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('dashboard.jenis-temuan.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    <div class="mb-4">
                        <label class="form-label" for="jenis_temuan">Jenis Temuan</label>
                        <input class="form-control" type="text" id="jenis_temuan" name="jenis_temuan" placeholder="Jenis Temuan">
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\job\dashboardusea3\resources\views/jenis-temuan/create.blade.php ENDPATH**/ ?>